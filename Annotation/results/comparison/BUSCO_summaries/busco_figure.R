...
# Output
my_output <- paste("/home/amas/annotation/BUSCO_summaries/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('busco_pasa_proteins', 'busco_pasa_proteins', 'busco_pasa_proteins', 'busco_pasa_proteins', 'busco_braker_proteins8', 'busco_braker_proteins8', 'busco_braker_proteins8', 'busco_braker_proteins8')
...
my_percentage <- c(73.7, 19.2, 2.7, 4.4, 74.1, 2.0, 2.0, 21.9)
my_values <- c(188, 49, 7, 11, 189, 5, 5, 56)
